						...
						<div class="card-body">
							...
							<div class="row bg-danger rounded text-white">
								<div class="col-md-12 text-center">
									...
									<h6 class="font-weight-bold"><i class="fa fa-warning"></i> El ID ingresado para verificar el certificado es incorrecto.</h6>
									<label class="font-italic"><i class="fa fa-info-circle"></i> Verifique que el código QR del certificado no tenga enmiendas ni raspaduras. Puede solicitar una copia legalizada de este certificado aperson&aacute;ndose a nuestra institución.</label>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 text-center">
