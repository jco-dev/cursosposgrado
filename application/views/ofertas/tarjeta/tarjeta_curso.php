    ...
    <div class="card card-custom gutter-b">
        <div class="card-body p-0">
            <div class="d-flex justify-content-between flex-column h-100">
                ...
                <img class="img-fluid" style="height: 165px; border-radius: 6px 6px 0px 0px;"
                    src="<?= base_url($curso->banner_curso) ?>" alt="Banner curso">
                ...
                <div class="p-3">
                    <div class="h-100">
                        ...
                        <div class="pt-3">
                            ...
                            <div class="d-flex align-items-center pb-2">
                                ...
                                <div class="d-flex flex-column flex-grow-1">
                                    <a href="#"
                                        class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Carga
                                        Horaria:</a>
                                </div>
                            ...
                            <div class="d-flex align-items-center pb-2">
                                ...
                                <div class="d-flex flex-column flex-grow-1">
                                    <a href="#"
                                        class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Inversión:</a>
                                </div>
                            ...
                            <div class="d-flex align-items-center pb-2">
                                ...
                                <div class="d-flex flex-column flex-grow-1">
                                    <a href="https://api.whatsapp.com/send/?phone=59162332648&text=M%C3%A1s%20informaci%C3%B3n%20sobre%20el%20curso%20de:%20*<?= $curso->fullname?>%20-%20UPEA*"
                            ...
                            <div class="d-flex align-items-center pb-2">
                                ...
                                <div class="d-flex flex-column flex-grow-1">
                                    <a href="#"
                                        class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Descuento:</a>
                                </div>
                    ...
                    <div class="d-flex justify-content-around pt-3">
                        <a href="<?= base_url($curso->url_pdf) ?>" target="_blank"
                            class="btn btn-primary btn-shadow-hover font-size-sm btn-sm font-weight-bold">
                            <i class="fa fa-eye icon-sm"></i>
                            Contenido
                        </a>
                        <a href="<?= base_url('informacion/index/' . base64_encode($this->encryption->encrypt($curso->id_course_moodle))) ?>"
