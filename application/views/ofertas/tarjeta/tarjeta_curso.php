            ...
            <div class="p-3">
                <div class="h-100">
                    ...
                    <div class="d-flex align-items-center pb-2">
                        ...
                        <!--end::Text-->
                        <!--begin::label-->
                        <span class="text-muted font-weight-bold min-w-45px">12-12-2021</span>
                        <!--end::label-->
                    </div>
                    <!--end::Item-->
                    ...
                    <div class="d-flex align-items-center pb-2">
                        ...
                        <div class="symbol symbol-30 symbol-light mr-4">
                            <span class="symbol-label">
                            <span class="svg-icon svg-icon-1x svg-icon-dark-50"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Home\Clock.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <!--end::Text-->
                        <!--begin::label-->
                        <span class="text-muted font-weight-bold min-w-45px">Plataforma habilitado 24/7</span>
                        <!--end::label-->
                    </div>
                    <!--end::Item-->
                    ...
                    <div class="d-flex align-items-center pb-2">
                        ...
                        <div class="symbol symbol-30 symbol-light mr-4">
                            <span class="symbol-label">
                                <span class="svg-icon svg-icon-1x svg-icon-dark-50"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Duplicate.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <!--begin::Text-->
                        <div class="d-flex flex-column flex-grow-1">
                            <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Carga Horaria:</a>
                        </div>
                        <!--end::Text-->
                        <!--begin::label-->
                        <span class="text-muted font-weight-bold min-w-45px">180 horas académicas</span>
                        <!--end::label-->
                    </div>
                    <!--end::Item-->
                    ...
                    <div class="d-flex align-items-center pb-2">
                        ...
                        <div class="symbol symbol-30 symbol-light mr-4">
                            <span class="symbol-label">
                            <span class="svg-icon svg-icon-1x svg-icon-dark-50"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Money.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <!--end::Text-->
                        <!--begin::label-->
                        <span class="font-weight-bolder label label-xl label-light-success label-inline px-3 py-5 min-w-45px">120 Bs.</span>
                        <!--end::label-->
                    </div>
                    <!--end::Item-->
                    ...
                    <div class="d-flex align-items-center pb-2">
                        ...
                        <div class="symbol symbol-30 symbol-light mr-4">
                            <span class="symbol-label">
                                <span class="svg-icon svg-icon-1x svg-icon-dark-50"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Call.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <!--begin::Text-->
                        <div class="d-flex flex-column flex-grow-1">
                            <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Celular:</a>
                        </div>
                        <!--end::Text-->
                        <!--begin::label-->
                        <span class="text-muted font-weight-bold min-w-45px">70648629-78956856</span>
                        <!--end::label-->
                    </div>
                    <!--end::Item-->
                    ...
                    <div class="d-flex align-items-center pb-2">
                        ...
                        <!--end::Text-->
                        <!--begin::label-->
                        <span class="text-muted font-weight-bold min-w-45px"><span class="label label-warning label-inline">20%</span> <span class="text-warning font-weight-boldest">hasta</span>  <span class="label label-warning label-inline">12-12-2020</span></span>
                        <!--end::label-->
                    </div>
                    <!--end::Item-->
                ...
                <div class="d-flex justify-content-around pt-3">
                    <button class="btn btn-primary btn-sm font-weight-bolder font-size-sm py-3">
                        <i class="fa fa-eye icon-sm"></i>    
                        Contenido
                    </button>
                    <button class="btn btn-primary btn-sm font-weight-bolder font-size-sm py-3">M&aacute;s informaci&oacute;n</button>
                    <button class="btn btn-primary btn-sm font-weight-bolder font-size-sm py-3">
