...
<head>
    ...
    <style type="text/css">
        @media only screen and (max-width: 640px) {
            ...
            body td[class].fullCenterMob {
                width: 100% !important;
                text-align: center !important;
                clear: both;
            }

            body body table[class=mcenter] {
                text-align: center;
...
<body style='margin: 0; padding: 0;'>
        ...
        <tbody>
            <tr>
                <td valign="top" align="center">
                    <table width="800" cellspacing="0" cellpadding="0" border="0" align="center" class="full">
                        <tbody>
                            <tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="font-size: 13px; color: #484848; text-align: justify; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 22px; vertical-align: top; font-weight: 400;" class="fullCenter opensans" mc:edit="16">
                                                                                                    ...
                                                                                                    <p style="text-align: justify;">Gracias por
                                                                                                        ...
                                                                                                        del curso: <strong><?php echo $curso; ?></strong><br>
                                                                                                    </p>
                                                                ...
                                                                <td width="100%" align="center">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td width="100%" align="center" style="line-height: 1px;" class="image71">
                                                                                    <a href="https://www.facebook.com/groups/927439791526349/" style="text-decoration: none;">
                                                                                        <img mc:edit="99" src="<?= base_url('assets/img/img_send_certificate/facebook.png') ?>" alt="" border="0" width="71" height="auto" style="width: 71px; height: auto;" class="hover" />
                                                                                    </a>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                    ...
                                                                    <table width="195" border="0" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; border-radius:5px; width: 195px; background:#457ad1;" bgcolor="#3ecaab" class="full">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td width="100%" align="center" style="line-height: 1px;" class="image71">
                                                                                    <a href="https://cursosposgrado.upea.bo/" style="text-decoration: none;">
                                                                                        <img mc:edit="102" src="<?= base_url('assets/img/img_send_certificate/email.png') ?>" alt="" border="0" width="71" height="auto" style="width: 71px; height: auto;" class="hover" />
                                                                                    </a>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                    ...
                                                                    <table width="195" border="0" cellpadding="0" cellspacing="0" align="right" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; border-radius:5px; width: 195px; background:#ecf0f4;" bgcolor="#ecf0f4" class="full">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td width="100%" align="center" style="line-height: 1px;" class="image71">
                                                                                    <a href="https://t.me/joinchat/Mczh3EU9cWkxMzNh" target="_blank" style="text-decoration: none;">
                                                                                        <img mc:edit="105" src="<?= base_url('assets/img/img_send_certificate/telegram.png') ?>" alt="" border="0" width="71" height="auto" style="width: 71px; height: auto;" class="hover" />
                                                                                    </a>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                    ...
                                                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full">
                                                        <tbody>
                                                            <tr>
                                                                <td width="100%" align="center">
                                                                    <a href="https://cursosposgrado.upea.bo" style="text-decoration: none;">
                                                                        <img mc:edit="108" src="<?= base_url('assets/img/img_send_certificate/logo.png') ?>" alt="" border="0" width="130" height="auto" style="width:130px; height: auto;" class="hover" />
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td width="100%" style="font-size: 14px; color: #457ad1; text-align: center; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 30px; vertical-align: top;font-weight: 600;" class="opensans" mc:edit="110">
                                                                    <p href="#" style="color: #457ad1; text-decoration:none">
                                                            ...
                                                            <tr>
                                                                <td width="100%" align="center">
                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center" style="color: #555555; font-size: 15px; font-weight: 900;" width="100%" height="22">TEAM PSG</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width="100%" height="30"></td>
                                                                            </tr>
    ...
    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="full">
        <tbody>
            <tr>
                            ...
                            <tr>
                                <td align="center">
                                    <table align="center" class="full" width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed;">
                                        <tbody>
                                            <tr>
                                                <td class="erase" style="line-height:1px; font-size:1px;" width="600">
                                                    <img src="<?= base_url('assets/img/img_send_certificate/transparant.png') ?>" height="1" style="max-height:1px; min-height:1px; display:block; width:600px; min-width:600px;" border="0" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
